    ...
    document.addEventListener('readystatechange', function() {
      ...
      tHeader0
      // .fromTo('.header__masking--maskLayer', { opacity: 0 }, {duration: 1, stagger: 0.3, opacity: 1, ease: 'expo.in'})

      .add('head', '+=2')
      // .to('.header__masking, .header__paralaxOne', { duration: 0, opacity: 0, ease: "none" }, 'head')
      ...
      $(window).scroll(function () {
        ...
        let value2 = window.scrollY;
          ...
          if( !(value2 >= 820) ) {
            ...
            planet2_black.style.transform  = "rotateY(20deg)";
            grass_black.style.marginTop = value2 * -0.12 + 'px';
            header_text_black.style.marginTop = value2 * 0.4 + 'px';
